...
It will run the tests because of the file [rest-assured-tests.yml](https://github.com/valentijnpeters/rest-assured-workshop/blob/main/.github/workflows/rest-assured-tests.yml) that is now added in the directory 'workflows'
study this file!
